 ...
 * Pobrane z Kurs Symfony RESTfull API Course 1
 * Dostęp do tej klasy dla testów poprzez ApiTestCase
 * https://github.com/knpuniversity/symfony2-rest/blob/master/resources/ResponseAsserter.php
 */
